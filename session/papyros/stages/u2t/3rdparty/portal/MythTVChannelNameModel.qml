...
XmlListModel {
    ...
    XmlRole{ name: "Chan1"; query: "ChannelInfo[1]/CallSign/string()" }
    XmlRole{ name: "Chan2"; query: "ChannelInfo[2]/CallSign/string()" }
    XmlRole{ name: "Chan3"; query: "ChannelInfo[3]/CallSign/string()" }
    XmlRole{ name: "Chan4"; query: "ChannelInfo[4]/CallSign/string()" }
    XmlRole{ name: "Chan5"; query: "ChannelInfo[5]/CallSign/string()" }

    XmlRole{name: "ChannelName1";query: "ChannelInfo[1]/ChannelName/string()" }
