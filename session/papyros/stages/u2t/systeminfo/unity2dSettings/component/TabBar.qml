...
Item {
    ...
    property int fontSize: container.height / -5
    ...
    property int gap: parent.height // !wide ? (container.height-buttonCount*buttonHeight)/(buttonCount+1) : (container.width-buttonCount*buttonWidth)/(buttonCount+1)
    // Calculated tab button dimensions
    property int buttonWidth: !wide ? container.width : container.height
    property int buttonHeight: parent.height  / 6 //!wide ? container.width-2*margins : container.width //-2*margins
...
//    property color backgroundBarColor: "white"
//    // 1st tab button graphics and text
//    property string button1Background: "../../../../dash/artwork/search_background.png"
//    property string button1BackgroundSelected: "../../../../dash/artwork/search_background_clear.png"
//    property string button1Text: "1"
//    // 2nd tab button graphics and text
//    property string button2Background: "../../../../dash/artwork/search_background.png"
//    property string button2BackgroundSelected: "../../../../dash/artwork/search_background_clear.png"
//    property string button2Text: "2"
//    // 3rd tab button graphics and text
//    property string button3Background: "../../../../dash/artwork/search_background.png"
//    property string button3BackgroundSelected: "../../../../dash/artwork/search_background_clear.png"
//    property string button3Text: "3"
//    // 4th tab button graphics and text
//    property string button4Background: "../../../../dash/artwork/search_background.png"
//    property string button4BackgroundSelected: "../../../../dash/artwork/search_background_clear.png"
//    property string button4Text: "4"
//    // Tab button margins
//    property int margins: 8
//    // Calculated gap between buttons
...
//            text: button1Text
//            buttonName: "page1Button"
//            target: "../example/DashSettings.qml"
//            width: buttonWidth
//            height: buttonHeight
//            active: container.selectedButton === buttonName
//            bgImage: button1Background
...
//            fontName: container.fontName
//            fontSize: container.fontSize
//            fontColor: "white"// container.fontColor
//            onClicked: { container.selectedButton = buttonName; container.tabButtonClicked(target, buttonName) }
//        }
//        ImageButton {
//            id: button2
