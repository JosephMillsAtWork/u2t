...
Renderer {
    ...
    property int cellWidth: Units.dtPx(158)
    property int cellHeight: Units.dtPx(76)
    property int minHorizontalSpacing: Units.dtPx(26)
    property int minVerticalSpacing: Units.dtPx(26)
    ...
    Grid {
        ...
        anchors{
            ...
            left: parent.left
            right: parent.right
            bottomMargin: Units.dtPx(12)
            leftMargin: Units.dtPx(2)
        }
