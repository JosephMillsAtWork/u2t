...
FocusScope {
    ...
    LayoutMirroring.enabled: launcher2dConfiguration.launcherLoader === "right" ? true : false
    ...
    function getActiveWindowIcon() {
        return activeWindow.icon ? "image://icons/" + activeWindow.icon : "image://icons/unknown"
    }
    ...
    Item {
        ...
        Item {
            ...
            anchors{
                left: parent.left
                leftMargin: unity2dConfiguration.formFactor === "tv" ? 25 : 0
                top: parent.top
            }
            width: launcher2dConfiguration.hideMode === 0 ? 0 : (launcherLoader.width)
            scale: unity2dConfiguration.formFactor === "tv" ? 1.2 : 1
                ...
                Rectangle {
                    ...
                    SearchEntry {
                        ...
                        height: if (unity2dConfiguration.formFactor == "tv")
                                    60
                                else if (unity2dConfiguration.formFactor === "desktop" || unity2dConfiguration.formFactor === "tablet")
                                    42
                        opacity: 1
